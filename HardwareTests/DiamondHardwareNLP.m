...
load('DiamondHardwareTrajectoryForNLP.mat')
...
for i = 1:control_traj_len
    if isequal(ctacts(:,i),ones(4,1))
        constr = [constr, ...
                  ...
                  x(6,i) <= xd(6,i) + 2/3*maxHeightDiff,...
...
save("DiamondHardwareTrajectoryDataWithCOM.mat",'trajGRF','trajCOM','pfd');

%% save COM, footstep, and GRF trajectories to compare to sim
save("DiamondHardwareTrajectoryWithCOMToCompare.mat",'x','v','pfd','u','F');
