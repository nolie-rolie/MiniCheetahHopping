...
mu = 0.4; % friction coefficient ... I'm making this up :0
...
h1 = 2e-1;
h = 2e-1; % timestep for discrete time system dynamics 
% h = 6e-1;
...
mu = 0.5; % friction coefficient ... I'm making this up :0
Af = [ 1  0 -mu/sqrt(2);
      -1  0 -mu/sqrt(2);
       0  1 -mu/sqrt(2);
       0 -1 -mu/sqrt(2);
...
platform2_xLB = -0.2;
platform2_xUB = 1.2;
platform2_yLB = platform1_yUB + 0.3;
platform2_yUB = platform2_yLB + 0.5;
platform2_z = 0;%.1;

platform3_xLB = platform1_xUB + 0.2;
platform3_xUB = platform3_xLB+1;
platform3_yLB = -0.5;
platform3_yUB = platform1_yUB;
platform3_z = 0;

platforms = [platform1_xLB platform1_xUB -platform1_yUB -platform1_yLB platform1_z;
             platform2_xLB platform2_xUB -platform2_yUB -platform2_yLB platform2_z;
             platform3_xLB platform3_xUB -platform3_yUB -platform3_yLB platform3_z];
...
obstacle1_xLB = 0.4;
obstacle1_xUB = 0.4;
obstacle1_yLB = platforms(3,3);
obstacle1_yUB = platforms(3,4);
obstacle1_zLB = 0;
obstacle1_zUB = 0.5;
...
% wall
[y,z] = meshgrid(obstacle1_yLB:0.1:obstacle1_yUB,0:0.1:obstacle1_zUB);
...
platforms(1,1) = platforms_true(1,1) + radius_platform/2;
platforms(1,2) = platforms_true(1,2) - radius_platform/2;
platforms(1,3) = platforms_true(1,3) + radius_platform/2;
platforms(1,4) = platforms_true(1,4) - radius_platform/2;
for i = 2:nFlatPlatforms
...
for i = 1:nHops+1
    ...
    if i == 1
        constr = [constr, ...
                  qdotTO(1,i) == h1 * (1/m*(C(i)*fnet(1,i) + -S(i)*fnet(2,i))), ...
                  qdotTO(2,i) == h1 * (1/m*(S(i)*fnet(1,i) + C(i)*fnet(2,i))), ...
                  qdotTO(3,i) == h1 * (1/m*fnet(3,i) + gravity(3)), ...
                  qdotTO(4,i) == h1 * 1/Ixx *(C(i)*n(1,i) + -S(i)*n(2,i)), ...
                  qdotTO(5,i) == h1 * 1/Iyy *(S(i)*n(1,i) + C(i)*n(2,i)), ...
                  qdotTO(6,i) == h1 * 1/Izz *n(3,i)];
    else
        constr = [constr, ...
...
for i = 1:nHops
    objective = objective + A*(fnet(1,i)^2 + fnet(2,i)^2);
...
save('ObstacleTrajectoryForNLP.mat','xd','ud','pfd','ctacts','platforms','obstacles')